...
//  public static final String REF_ATT_TARGET = "target";
   ...
   * @return decode RefItem, or <i>i</i> if <i>i</i> is already a RefItem, or
   * <code>null</code> if <i>i</i> decodes to no item (it is 
   * the end tag for a tree reference)
   * @throws IOException if an I/O error occurs
   */
  public static final Item decode(Item i) throws IOException {
    switch(whatItem(i)) {
      case ITEM_DECODED: return i;
      case ITEM_TREEREF_CLOSE: return null; // BUGFIX-20070625-1
