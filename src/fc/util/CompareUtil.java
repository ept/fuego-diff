...
public class CompareUtil {
    ...
    /**
     * Comparator that orders short strings before longer ones. Same-length strings are
     * alphabetically ordered. May be used to e.g. sort number strings
     */
    ...
    /**
     * Comparator that order objects by their string representation. The String representation is
     * obtained by calling <code>object.toString()</code>.
     */
    ...
    /**
     * Comparator that orders by object identity. The only meaningful result of this comparison is
     * identity, i.e, 0. More specifically, the comparator only returns 0 iff <code>o1==o2</code>.
     */
    ...
    /**
     * Comparator that orders by object equality. The only meaningful result of this comparison is
     * identity, i.e, 0. More specifically, the comparator only returns 0 iff
     * <code>o1.equals(o2)</code> and <code>o2.equals(o1)</code>. (The double check is to guard
     * against cross-class buggy equals().
     * <p>
     * Note: includes a check for symmetric equals as an assertion.
     */
