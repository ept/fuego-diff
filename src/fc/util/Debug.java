...
public class Debug {
    ...
    /**
     * Get a string describing the object contents suitable for debug output. This method should
     * produce useful debug printouts for almost anything you throw at it.
     * @param o
    ...
    public static String toString(Object o, int level) {
        ...
        if (c != null && c.isArray()) {
            if (o instanceof byte[]) return Util.toPrintable((byte[]) o);
            Object[] objs2 = box(o);
    ...
    public static Object[] box(Object o) {
        ...
        if (o instanceof byte[]) {
            ...
            return val;
        } else if (o instanceof Object[]) return (Object[]) o;
        return null;
    }
    ...
    /**
     * A simple timing system. The point of this class is to easily mark some point in time, and
     * then recall or get the elapsed time since that mark. In particular, your code won't need to
     * keep track of any handles, because you can use existing objects. Also, any timing information
     * is automatically discarded with its object.
     * <p>
     * For something more advanced in terms of control and book-keeping, see the {@link Measurer}
     * class.
     * @author ctl
     */
    public static class Time {
        ...
        private static Map<Object, Long> timeStamps = new WeakHashMap<Object, Long>();
        ...
        /**
         * Record the current time, and associate it with the given handle. Typically this handle
         * can be <code>this</code> of the calling object.
         * @param handle
        ...
        /**
         * Stamp and return handle. The handle will be removed when calling since() without a
         * handle. These handles work like a stack, i.e., the latest stamp() handle is destroyed by
         * since()
         */
        ...
        /**
         * Get object containing elapsed time. When toString() is called, the object will create a
         * suitably formatted String.
         * @param handle
    ...
    public static class Measure {
        ...
        private static Map<Object, Long> values = new WeakHashMap<Object, Long>();
        ...
        /**
         * Read value using handle. A timing handle will return a timing value, as by
         * <code>Time.get</code>.
         * @param handle
         * @return timestamp
         */
        public static long get(Object handle) {
            ...
            if (l == null) { return Time.get(handle); }
            return l - bias;
        }
