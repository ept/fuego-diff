...
/**
 * Immutable list on top of an array. Really fast access and subList. Never copies the underlying
 * array.
...
public class ImmutableArrayList<E> implements List<E> {
    ...
    /*
     * The java.lang.Object version should be OK public int hashCode() { throw new
