...
public abstract class MagicInputStream extends FilterInputStream {
    ...
    public String getMimeType() throws IOException {
        return mimeType == null ? (origIn instanceof MagicInputStream ? ((MagicInputStream) origIn).getMimeType()
                : null)
                : mimeType;
    }
     ...
     * @param len
     *            int Length of magic signature
     * @param magic
     *            byte[] magic signature, i.e. the first n bytes of the stream
