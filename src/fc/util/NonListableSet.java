...
/**
 * A set that is immutable, and whose members cannot be enumerated. In practice, this is a Set which
 * only supports querying for item membership. Useful for infinite or very large sets that are only
 * sparsely accessed.
