...
/**
 * A queue (FIFO) of objects. In MIDP there is no linked list class that could be used as an
 * efficient queue. This is a from-scratch typical implementation of such a data structure. In the
 * normal Java world you are better off using a {@link java.util.LinkedList} directly.
 * <p>
 * The operations have been modelled after those in {@link Stack}.
...
public class Queue {
    ...
    /**
     * Return the item at the head of the queue. Unlike {@link #dequeue}, this method does not
     * remove the item.
