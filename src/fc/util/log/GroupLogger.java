...
/**
 * A class for logging by thread group. The methods in this class provide a way to direct the
 * loggings of different thread groups to different loggers.
 * @author Jaakko Kangasharju
 */
public class GroupLogger extends AbstractLogger {

    private static Map<ThreadGroup, Logger> loggers = new HashMap<ThreadGroup, Logger>();


    /**
     * Install a logger logging to the given stream. This class is a convenience method that
     * installs a {@link StreamLogger} to log to the given stream at the default level. The group to
    ...
    /**
     * Install a logger logging to the given stream. This class is a convenience method that
     * installs a {@link StreamLogger} to log to the given stream at the given level. The group to
     * associate the new logger with is the current thread's group.
     * @param out
     *            the stream to log into
     * @param level
    ...
    /**
     * Install a logger for this thread group. The group to associate the new logger with is the
     * current thread's group.
     * @param logger
     *            the logger to use for this thread group
     */
     ...
     * @return whether this thread group already has an associated logger
     */
