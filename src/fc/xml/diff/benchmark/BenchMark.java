        ...
        if (program.startsWith("!")) {
            ...
            try {
                ...
                try {
                    ...
                    Thread.yield();
                    /*
                     * final Thread mainThread = Thread.currentThread(); Thread watchDog = new
                     * Thread() { public void run() { try { Thread.sleep(timeout);
                     * mainThread.interrupt(); } catch (InterruptedException ex){} } };
                     * watchDog.start();
                     */
