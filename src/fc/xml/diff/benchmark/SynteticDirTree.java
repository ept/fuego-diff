...
public class SynteticDirTree extends BenchMark {
    ...
    public void start() {
        ...
        for (int tsize = tstart; tsize < tend; tsize += step) {
            for (int lap = 0; lap < tlaps; lap++) {
                ...
                MutableRefTree baset = DirTreeGenerator.randomDirTree(rtsize, DSIZE, DPROB, VAR,
                                                                      DVAR, new Random(rndSeed));
                // Make variants
    ...
    private void verifyDiff(String patcher, File basef, File newf, File deltaf) {
        ...
        try {
            ...
            IdAddressableRefTree pT = RefTrees.getAddressableTree(XasSerialization.readTree(pes, tm));
            ...
            IdAddressableRefTree nT = RefTrees.getAddressableTree(XasSerialization.readTree(nes, tm));
    ...
    public static void refTreeCmp(RefTreeNode n1, RefTreeNode n2, IdAddressableRefTree base,
                                  Key rtId) {
