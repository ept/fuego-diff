...
/*
 * Generator for directory trees. This code is a light refactoring of the dirtree testing generator
 * found in Syxaw NOTE: The code is ugly in its mixed use of strings and StringKeys. There's no
 * reason t use both.
 */
...
public class DirTreeGenerator {
    ...
    public static void permutateTree(fc.xml.xmlr.MutableRefTree t, long ops, String pdf,
                                     double deleteTreeProb, final Random rnd) {
        SortedSet treeNodes = new TreeSet<String>(new Comparator() {

            final int seed = rnd.nextInt(); // Gives a quite random order --
        ...
        for (; ops > 0; ops--) {
            ...
            redo = false;
            // The selection proc below may choose a file only once, but a dir
            // as
            ...
            try {
                redo: switch (op) {
                    ...
                    case 'd': // delete
                        ...
                        /*
                         * { RefTreeNode _n = rndNode; while (_n != null &&
                         * !ROOT_ID.equals(_n.getId())) { _n = _n.getParent(); } if (_n == null) {
                         * Log.log("Working around ChangeTree delete bug" ,Log.WARNING); break; } }
                         */
                        if (rndNode == null || ROOT_ID.equals(rndNode.getId())) break; // Never
                        // delete
                        // root
                        {
                            ...
                            /*
                             * Sweep delete for( Iterator i = deletia.iterator(); i.hasNext(); ) {
                    ...
                    case 'u':
                        ...
                        String newName = c.getType() == DirectoryEntry.FILE ? fileName(
                                                                                       nextId().toString(),
                                                                                       rnd)
    ...
    private static void treeSet(fc.xml.xmlr.MutableRefTree t, RefTreeNode root, Set s, char op) {
        switch (op) {
            case '+':
    ...
    public static MutableRefTree randomDirTree(long nodes, long nodesPerDir, double dirProb,
                                               double variance, double dirVariance, Random rnd) {
        Key id = nextId();
        MutableRefTree t = new DirTreeGenerator.MutableRefTree(
                                                               id,
                                                               new DirectoryEntry(
                                                                                  id,
                                                                                  null,
    ...
    public static String fileName(String id, Random rnd) {
        ...
        final String[] exts = { "c", "java", "txt", "h", "doc", "xml", "gif", "jpg", "tmp",
                               "class", "ps", "tex" };
        return fnames[rnd.nextInt(fnames.length)] + "-" + id + "." + exts[rnd.nextInt(exts.length)];
    }
     ...
     * 
     * private Key id; private String name; private int type;
     * 
     * public DirNodeContent() { this(null,null,-1); }
     * 
     * public DirNodeContent(DirNodeContent src) { id = src.id; name = src.name; type = src.type; }
     * 
     * 
     * public DirNodeContent(Key aId, String aName, int aType) { id = aId; name = aName; type =
     * aType; }
     * 
     ...
     * 
     * public String getName() { if( type == DirectoryEntry.TREE ) // The tree has no name attr!
     * return null; return name; }
     * 
     * public int getType() { return type; }
     * 
     * public boolean equals(Object o) { return o instanceof DirectoryEntry && (
     * Util.equals(((DirectoryEntry) o).getId(),getId()) && Util.equals(((DirectoryEntry)
     * o).getName(),getName()) && ((DirectoryEntry) o).getType()==getType() ); }
     * 
     * // dummies public String getLocationId() { return "#lid#"; }
     * 
     * public String getNextId() { return "#nextid#"; }
     * 
     * public String getUid() { return "#uid#-"+getId(); }
     * 
     * public int getVersion() { return 0; }
     * 
     * public String getLinkNextId() { return "#lnextid#"; }
     * 
     * public String getLinkUid() { return "#luid#"; }
     * 
     * public int getLinkVersion() { return 1; }
     * 
     * public Key getLinkId() { return id; }
     * 
     * // public boolean getIsFile() { // return TYPE_FILE.equals(getType()); // } }
     */
