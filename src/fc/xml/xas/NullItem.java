...
/**
 * An item with no content. This item simply takes up space, it has no behavior or serialized form.
 * It is useful in cases where an item needs to be deleted from an array without incurring a
 * performance penalty.
 */
