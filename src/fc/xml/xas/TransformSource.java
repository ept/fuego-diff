...
/**
 * A wrapper source for easy transformations. This class wraps an underlying {@link ItemSource} and
 * uses an {@link ItemTransform} to transform the items coming from the source. While this class
