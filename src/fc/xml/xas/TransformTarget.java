...
/**
 * A wrapper target for easy transformations. This class wraps an underlying {@link ItemTarget} and
 * uses an {@link ItemTransform} to transform the items being output to the target. While this class
 * works in all transformation situations, special-purpose wrappers may provide more efficiency.
 */
