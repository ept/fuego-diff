...
/**
 * A fragment containing a single item. This wrapper is useful in cases where an existing fragment
 * is replaced by a single item, since the replacing item needs to inherit the replaced fragment's
 * size.
 */
