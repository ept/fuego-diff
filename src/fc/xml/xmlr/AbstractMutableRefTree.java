...
/**
 * Convenience base class for mutable reftree implementations. Provides implementations of
 * <code>move</code> and <code>insert</code> without position arguments in terms of those with
 * positions, in order to protect against inconsistencies among these.
 */

public abstract class AbstractMutableRefTree extends IdAddressableRefTreeImpl implements
        MutableRefTree {
    ...
    public abstract Key insert(Key parentId, long pos, Key newId, Object content)
            throws NodeNotFoundException;
    ...
    public final Key move(Key nodeId, Key parentId) throws NodeNotFoundException {
