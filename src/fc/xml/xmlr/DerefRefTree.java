...
public class DerefRefTree implements IdAddressableRefTree {
  ...
  protected class FrontProxyNode implements RefTreeNode {
    ...
    public FrontProxyNode(RefTreeNode n) {
      assert _modCounts.put(System.identityHashCode(this)&_MODCOUNT_KEYMASK,
          modCount)==null || true;
      assert !n.isTreeRef();
      assert n != null;
      this.n = n;
    ...
    protected boolean checkModCount() {
      Integer count = _modCounts.get(
          System.identityHashCode(this)&_MODCOUNT_KEYMASK );
    ...
    /*protected void finalize() {
      assert modCounts.remove(System.identityHashCode(this))!=null || true;
    }*/
  }
