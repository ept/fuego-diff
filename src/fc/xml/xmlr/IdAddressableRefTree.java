...
/**
 * A reftree that can be accessed by node ids in a random-access fashion. The identifiers of the
 * nodes in this class of trees are required to be unique. An IdAddressableRefTree is typically used
 * to hold the common base tree to which the references in a set of reftrees point.
 */
