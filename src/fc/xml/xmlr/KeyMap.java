...
/**
 * Map for mapping between keys of two trees. The two trees are conceptually the back
 * (bottom/underlying/old) tree and the front (top/overlying/new) tree. The methods have names to
 * reflect which which tree the returned key belongs.
 * <p>
 * NOTE: When using this interface, be careful to consistently denote one tree as front and the
 * other as back, and your code shall be sublime. Mix these up, and you won't make head or tails of
 * anything.
 */
...
public interface KeyMap {
    ...
    /**
     * Reverse map. That is, front keys of the underlying map appear as back keys, and vice versa.
     */
