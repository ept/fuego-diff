...
/**
 * Key based on object identity. The toString() output may be identical for some keys, in the very
 * unlikely case that the VM produces non-unique <code>System.identityHashCode()</code>s.
 */
