...
/**
 * A class for associating an EOA and a DOA machine.  An object of
 * this class holds a pair consisting of a {@link EoaMachine} and a
 * {@link DoaMachine}.  The assumption is that these machines are the
 * inverses of each other.  The class is provided so that the
 * association between inverse machines is easily preservable in
 * systems.
 */
