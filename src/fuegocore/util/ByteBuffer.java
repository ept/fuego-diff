/* ByteBuffer.java -- Growable strings
   Copyright (C) 1998, 1999, 2000, 2001, 2002 Free Software Foundation, Inc.
   Copyright (C) 2006 Helsinki Institute for Information Technology
...
/*
 * Modified to implement a ByteBuffer for the Fuego Core project by
 * Jaakko Kangasharju.
 */
...
/**
 * <code>ByteBuffer</code> represents a changeable array of
 * <code>byte</code>s.  It provides the operations required to modify
 * the <code>ByteBuffer</code>, including insert, replace, delete,
 * append, and reverse. It is thread-safe; meaning that all
 * modifications to a buffer are in synchronized methods.
 *
 * <p><code>ByteBuffer</code>s are variable-length in nature, so even
 * if you initialize them to a certain size, they can still grow
 * larger than that. <em>Capacity</em> indicates the number of
 * characters the <code>ByteBuffer</code> can have in it before it has
 * to grow (growing the byte array is an expensive operation involving
 * <code>new</code>).
 *
 * @author Paul Fisher
 * @author John Keiser
...
public final class ByteBuffer implements Serializable
{
  ...
  /**
   * True if the buffer is shared with another object (ByteBuffer or
  ...
  /**
   * Create an empty <code>ByteBuffer</code> with the specified initial
   * capacity.
   *
  ...
  /**
   * Get the length of the <code>String</code> this <code>ByteBuffer</code>
  ...
  /**
   * Get the total number of characters this <code>ByteBuffer</code> can
  ...
  /**
   * Increase the capacity of this <code>ByteBuffer</code>. This will
  ...
  /**
   * Set the length of this ByteBuffer. If the new length is greater than
  ...
  /**
   * Append the <code>ByteBuffer</code> value of the argument to this
   * <code>ByteBuffer</code>.
   *
   * @param stringBuffer the <code>ByteBuffer</code> to convert and append
  ...
  /**
   * Append the <code>byte</code> array to this <code>ByteBuffer</code>.
   * This is similar (but more efficient) than
   * <code>append(new String(data))</code>, except in the case of null.
   *
   * @param data the <code>byte[]</code> to append
   * @return this <code>ByteBuffer</code>
  ...
  /**
   * Append part of the <code>byte</code> array to this
   * <code>ByteBuffer</code>. This is similar (but more efficient) than
   ...
   *
   * @param ch the <code>byte</code> to append
   * @return this <code>ByteBuffer</code>
   */
  ...
  /**
   * Delete characters from this <code>ByteBuffer</code>.
  ...
  /**
   * Creates a substring of this ByteBuffer, starting at a specified index
   * and ending at the end of this ByteBuffer.
   *
  ...
  /**
   * Insert a subarray of the <code>byte[]</code> argument into this
   * <code>ByteBuffer</code>.
   *
   * @param offset the place to insert in this buffer
   * @param str the <code>byte[]</code> to insert
   ...
   * @since 1.2
   */
  public synchronized ByteBuffer insert(int offset,
                                          byte[] str, int str_offset, int len)
  {
  ...
  /**
   * Insert the <code>byte[]</code> argument into this
   * <code>ByteBuffer</code>.
   *
   * @param offset the place to insert in this buffer
   * @param data the <code>byte[]</code> to insert
   * @return this <code>ByteBuffer</code>
   ...
   *
   * @param offset the place to insert in this buffer
   * @param ch the <code>byte</code> to insert
   * @return this <code>ByteBuffer</code>
   * @throws StringIndexOutOfBoundsException if offset is out of bounds
   */
  ...
  /**
   * Reverse the characters in this ByteBuffer. The same sequence of
  ...
  /**
   * Convert this <code>ByteBuffer</code> to a <code>String</code>. The
   * String is composed of the characters currently in this ByteBuffer. Note
  ...
  /**
   * Get the byte array behind this <code>ByteBuffer</code>.  The
   * returned array is still owned by the buffer and must not be
   * modified.
   *
