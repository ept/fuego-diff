 ...
 * <p>
 * This class should be J2ME-friendly. Place any methods not compatible with J2ME into the
 * {@link ExtUtil} class.
 */
public final class Util {
     ...
     * considered equal if the result of applying {@link String#toLowerCase} to both of them results
     * in strings that compare equal.
     */
    ...
    /**
     * Make sure an array has enough space. This method will return an array that has at least the
     * specified size, given as a multiplier and number of multiples, and the contents of the given
     * array, preferring to return the array passed to it.
     * <p>
     * Use of this method indicates unwarranted chumminess with the implementation.
     * @param array
     *            the array to enlarge
     * @param needed
     *            the minimum size for the returned array
