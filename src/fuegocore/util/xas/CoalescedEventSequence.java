...
/**
 * An event sequence that coalesces all content events. This {@link EventSequence} implementation
 * takes an underlying {@link EventSequence} and provides a view of that where there are no
 * consecutive {@link Event#CONTENT} events. This is useful when e.g. using the XML serialization
 * format and there are many escaped characters that would each be returned as separate
...
public class CoalescedEventSequence extends TransformedEventStream {
     ...
     * @param es
     *            the {@link EventSequence} to wrap and provide content coalescing for
     */
