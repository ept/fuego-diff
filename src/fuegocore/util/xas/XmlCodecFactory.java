...
/**
 * A factory for textual XML serializers and parsers. The serializers and parsers produced by this
 * factory use the standard textual format of XML. This is a Singleton object, which is
 * automatically registered as the factory to use for types <code>"text/xml"</code> and
 * <code>"application/soap+xml"</code> in {@link CodecIndustry}.
 */
public class XmlCodecFactory implements CodecFactory {
    ...
    /**
     * Return the XML codec factory. This method just returns the Singleton object that is
     * registered as the factory for XML types.
     */
    ...
    /**
     * Return a new XML parser. The returned parser reads textual XML. The token is ignored; a new
     * parser, unrelated to any previous parsers, is always created.
     */
    ...
    /**
     * Return a new XML serializer. The returned serializer writes textual XML. The token is
     * ignored; a new serializer, unrelated to any previous serializers, is always created.
     */
