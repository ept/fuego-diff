...
/**
 * A typed content codec factory for the {@link java.util.Hashtable} type. This
 * {@link ContentCodecFactory} builds encoders and decoders recognizing the
 * {@link java.util.Hashtable} Java type. The XML name given for this type has namespace
 * {@link XasUtil#XAS_NAMESPACE} and local name <code>"hashtable"</code>. This type mapping is
...
public class HashtableCodecFactory extends ContentCodecFactory {
    ...
    static {
        try {
            ContentCodecFactory.addTypeMapping(Class.forName("java.util.Hashtable"),
