...
/**
 * A typed content encoder for the {@link Hashtable} type. This class implements the
 * {@link ContentEncoder} interface for encoding {@link Hashtable} objects into XML.
 */
        ...
        if (Util.equals(namespace, XasUtil.XAS_NAMESPACE) && Util.equals(name, "hashtable")) {
            if (o instanceof Hashtable) {
                ...
                for (Enumeration e = h.keys(); e.hasMoreElements();) {
                    ...
                    if (kname != null) {
                        xw.typedElement(XasUtil.XAS_NAMESPACE, "key", kname.getNamespace(),
                                        kname.getName(), k);
                    } else {
                    ...
                    if (vname != null) {
                        xw.typedElement(XasUtil.XAS_NAMESPACE, "value", vname.getNamespace(),
                                        vname.getName(), v);
                    } else {
