...
/**
 * A typed content encoder for the {@link Vector} type. This class implements the
 * {@link ContentEncoder} interface for encoding {@link Vector} objects into XML.
 */
        ...
        if (Util.equals(namespace, XasUtil.XAS_NAMESPACE) && Util.equals(name, "vector")) {
            if (o instanceof Vector) {
                ...
                for (Enumeration e = v.elements(); e.hasMoreElements();) {
                    ...
                    if (qname != null) {
                        xw.typedElement(XasUtil.XAS_NAMESPACE, "item", qname.getNamespace(),
                                        qname.getName(), i);
                    } else {
