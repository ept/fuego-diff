...
public final class Util {
    ...
    public static <T extends Throwable> void throwWrapped (T throwed,
	    Throwable wrapped) throws T {
    ...
    /** Get iterable out of iterator. Convenience method to bypass JDK5 brain 
     * damage.
     */
