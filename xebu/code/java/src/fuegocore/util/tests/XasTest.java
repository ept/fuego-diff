...
/**
 * Test the XAS implementation.  This class tests that the XAS event
 * sequences function properly and that the various codecs do
 * something sensible.
 */
public class XasTest extends TestCase {
	...
	for (Iterator i = sequences.iterator(); i.hasNext(); ) {
		...
		System.out.println(index++);
		Node n = XasExtUtil.sequenceToDom(XasExtUtil.newDocument(),
						  seq);
